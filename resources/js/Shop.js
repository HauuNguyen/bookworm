...
class Shop extends React.Component {
    ...
    async componentDidMount(){
        await axios.get('http://127.0.0.1:8000/api/allbook').then(respone=>{
                                ...
                                <div className="col-md-12"> hello
                                
                                     {
                                        ...
                                        <div className="col-lg-3 col-md-4 col-sm-6 mb-4" key={book1}>
                                            <div >
                                                <img  src={bookCoverPhoto[book1.book_cover_photo]} alt={book1.book_cover_photo} />
                                                <div >
